...
Plugin URI: http://shad9w.net/wp-keys-giveaway
Description: Do you have some keys for a software or videogame and want to give them to your users? This plugin allows you to add the keys to the database and let your users just get one key.
Version: 1.0
Author: Shad9w
Author URI: http://shad9w.net
*/
...
),'menu_icon' =>'http://gameslike.com/wp-content/plugins/key-giveaway/images/icon.png',
));
}
